#include <iostream> 
 ...
 NoArvore* topoPilha(ElementoPilha *topo){
    if(topo != NULL){
        return topo -> data;
    }
 }
  
 void preOrdem(NoArvore *raiz, ElementoPilha *topo){ 
         if (raiz != NULL){ 
            empilhaNo(topo, raiz);
            while(topo != NULL){
                NoArvore* aux;
                ...
                desempilhaNo(topo);
                if(aux -> right != NULL){
                    empilhaNo(topo, aux -> right);
                }
                if(aux -> left != NULL){
                    empilhaNo(topo, aux -> left);
                }
            }
         } 
 } 

 void emOrdem(NoArvore *raiz, ElementoPilha *topo){
        if (raiz != NULL){
                while(topo != NULL){
                        NoArvore* aux;
                        aux = topoPilha(topo);
 ...
 int main(){ 
         ...
         ElementoPilha* pilha = new ElementoPilha;
         pilha = NULL;
